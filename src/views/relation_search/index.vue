    ...
    <el-row style="height: 50vh">
      <el-col :span="12">
        ...
        <div style="text-align:center">
          <el-button type="primary" @click="search(form)" size="small" style="margin-left:3vh;margin-top:10px" plain>查询</el-button>
        </div>
      </el-col>
      <el-col :span="1">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="查询结果" name="search" >
            <el-table :data="result" v-loading="isLoading"
              element-loading-text="正在为您查询..." stripe style="width: 100%" height="400">
  ...
  methods: {
    ...
    search(form){
      ...
      else
      {
        ...
        //neo4j关系查询
        this.$axios.post("/neo4j/comprehensive/relation", {
          source:form.source,
          target:form.target,
          name:form.name,
          times:form.times,
        ...
        //spark关系查询
        this.$axios.post("/spark/comprehensive/relation", {
          source:form.source,
          target:form.target,
          name:form.name,
          times:form.times,
